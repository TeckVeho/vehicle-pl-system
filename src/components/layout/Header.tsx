...
export function Header() {
  ...
  const isMasterActive = pathname.startsWith("/account-items") || pathname.startsWith("/arbitrary-insurance") || pathname.startsWith("/location-calculation-parameters") || pathname.startsWith("/locations") || pathname.startsWith("/course-vehicle-mapping");
