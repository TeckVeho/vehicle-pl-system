<template>
	<div>
		<b-row class="reset-password mx-auto">
		...
		<b-row class="mt-3">
			<b-col cols="12" class="text-center">
				<b-button class="button-submit" @click="resetPassword()">
					<b-spinner
						v-if="isLoading"
						:disabled="isLoading"
						variant="primary"
...
<script>
import { postResetPassword } from '@/api/modules/reset-password';
import { validateResetPassword } from './validation';

const urlAPI = {
    apiResetPassword: '/register-password',
};
    ...
    methods: {
        ...
        async resetPassword() {
            try {
                ...
                if (validateResetPassword(DATA) === true) {
