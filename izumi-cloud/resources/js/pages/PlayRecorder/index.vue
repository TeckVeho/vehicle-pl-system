...
<script>
const URL_API = {
    detailRecorder: '/driver-recorder',
};
        ...
        while (idx < len) {
            ...
            document.getElementById(listRef[idx]).addEventListener('ended', (e) => {
                ...
                if (e.srcElement.id === allRef[this.idxRecorderMax]) {
                    ...
                    const next_idx_recorder = parseInt(this.idxRecorder) + 1;

                    const route = this.$router.resolve({
                        name: 'PlayRecorder',
                        params: {
                            id: this.$route.params.id,
                            idx: next_idx_recorder < this.list_movies.length ? next_idx_recorder : 0,
                        },
                    });
