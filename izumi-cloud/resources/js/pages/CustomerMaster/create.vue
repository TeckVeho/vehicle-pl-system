<template>
	...
	>
		...
		<div class="customer-master-create">
			<b-col>
				<div class="customer-master-create__header">
					<vHeaderPage>
						{{ $t("ROUTER_CUSTOMER_MASTER") }}
					</vHeaderPage>
				</div>

				<div class="customer-master-create__body">
...
import { postCustomer } from '@/api/modules/customerMaster';
...
export default {
    ...
    methods: {
        ...
        async handlePostCustomer() {
            ...
            try {
                const URL = urlAPI.postCustomer;
                const DATA = {
                    customer_name: this.customerName,
                };

                const res = await postCustomer(URL, DATA);
