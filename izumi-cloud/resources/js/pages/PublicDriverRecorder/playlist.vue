...
<script>
const URL_API = {
    detailRecorder: '/api/driver-recorder-play-list-viewer',
};
...
export default {
            ...
            document.getElementById(listRef[idx]).addEventListener('ended', (e) => {
                ...
                if (e.srcElement.id === allRef[this.idxRecorderMax]) {
                    ...
                    if (!this.is_replay) {
                        ...
                        const route = this.$router.resolve({ path: `/public-playlist/${this.$route.params.id}` });
    ...
    methods: {
        ...
        handleSkipPlaylist() {
            ...
            const URL = `${window.origin}/public-playlist/${this.$route.params.id}`;
