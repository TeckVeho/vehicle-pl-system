...
import CourseMasterEdit from '@/pages/CourseMaster/edit';

describe('TEST COMPONENT COURSE MASTER EDIT', () => {
    const mocks = {
        $toast: {
            show: jest.fn(),
            success: jest.fn(),
    ...
    it('Test render data', () => {
        ...
        const wrapper = mount(CourseMasterEdit, {
            localVue,
            router,
            store,
            stubs: {
    ...
    it('Test render header', () => {
        ...
        store.dispatch('user/saveLogin', {
            ...
            const HEADER = wrapper.find('.course-master-edit__header');
    ...
    it('Test render form', () => {
        ...
        store.dispatch('user/saveLogin', {
            ...
            const ZONE_FORM = wrapper.find('.course-master-edit');
    ...
    it('Test click button back', async() => {
        ...
        const ZONE = wrapper.find('.course-master-edit__handle');
    ...
    it('Test click button save', async() => {
