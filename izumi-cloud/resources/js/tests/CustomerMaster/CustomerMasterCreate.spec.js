...
import CustomerMasterCreate from '@/pages/CustomerMaster/create';

describe('TEST COMPONENT CUSTOMER MASTER CREATE', () => {
    test('Test render data', () => {
        const localVue = createLocalVue();
        const wrapper = mount(CustomerMasterCreate, {
            localVue,
            router,
            store,
            stubs: {
    ...
    test('Test render header', () => {
        ...
        const PAGE = wrapper.find('.customer-master-create');
        const HEADER = PAGE.find('.customer-master-create__header');
    ...
    test('Test render form', () => {
        ...
        const PAGE = wrapper.find('.customer-master-create');
        const BODY = PAGE.find('.customer-master-create__body');
